...
cicy-rpc webpage_screenshot_to_clipboard
...
# 清理输入框
cicy-rpc gemini_web_clear_prompt

# 确保窗口在 Gemini 页面
cicy-rpc gemini_web_ensure
```
...
# 2. 打开 Gemini 窗口
cicy-rpc open_window url=https://gemini.google.com/app reuseWindow=false

# 3. 粘贴图片到 Gemini
cicy-rpc gemini_paste_image

# 4. 设置问题并发送
cicy-rpc gemini_web_set_prompt text="描述这个网页的视觉风格"
cicy-rpc gemini_web_click_send
...
# 窗口2粘贴
cicy-rpc gemini_paste_image win_id=2
```
