...
contextBridge.exposeInMainWorld("panelAPI", {
  ...
  setProfileType: (accountIdx, type) => ipcRenderer.invoke("panelcells:set-profile-type", { accountIdx, type }),
  setProfileTabUrl: (accountIdx, url) => ipcRenderer.invoke("panelcells:set-profile-tab-url", { accountIdx, url }),
